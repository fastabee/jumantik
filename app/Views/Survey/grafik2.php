...
<div class="container">
    ...
    <p style="padding-top: 5px; font-style: italic;">
        Berdasarkan grafik diatas total terjangkit demam berdarah adalah <?= array_sum($totals); ?>.
    ...
    <!-- Input Link dan Tombol Salin -->
    <div style="margin-top: 20px;">
        <label for="downloadLink" style="display: block; font-weight: bold;">Link Download:</label>
        <div style="display: flex; align-items: center; gap: 10px;">
            <input
                type="text"
                id="downloadLink"
                value="https://f2f6-203-29-27-211.ngrok-free.app/jumantik/grafik/1"
                readonly
...
<script>
    document.getElementById('copyLink').addEventListener('click', function () {
        ...
        downloadLinkInput.setSelectionRange(0, 99999); // Untuk kompatibilitas dengan perangkat lama

        // Salin teks ke clipboard
        navigator.clipboard.writeText(downloadLinkInput.value).then(function () {
